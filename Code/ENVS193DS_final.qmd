...
residuals0 <- simulateResiduals(model0) # null
residuals1 <- simulateResiduals(model1) # saturated 
residuals2 <- simulateResiduals(model2) # visual obstruction only
residuals3 <- simulateResiduals(model3) # distance to prarie dog colony only
